...
// This module makes stdin emit keypress events,
...
import React, { FC, FunctionComponent, PropsWithChildren, useEffect, useMemo, useRef, useState } from "react";
...
const HighlightComponent: FC = ({ children }) => <Text backgroundColor="#6C71C4">{children}</Text>;
