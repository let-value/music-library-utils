...
export class init1650818337974 implements MigrationInterface {
    name = 'init1650818337974'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "playlist_to_track" ("Order" integer NOT NULL, "playlistId" integer NOT NULL, "trackName" varchar NOT NULL, "albumName" varchar NOT NULL, "trackArtistName" varchar NOT NULL, "AddedAt" datetime NOT NULL DEFAULT (datetime('now')), "albumArtistName" varchar, PRIMARY KEY ("Order", "playlistId", "trackName", "albumName", "trackArtistName"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_playlist_to_track" ("Order" integer NOT NULL, "playlistId" integer NOT NULL, "trackName" varchar NOT NULL, "albumName" varchar NOT NULL, "trackArtistName" varchar NOT NULL, "AddedAt" datetime NOT NULL DEFAULT (datetime('now')), "albumArtistName" varchar, CONSTRAINT "FK_cf6e5710c8d656b7f7c0882ff8b" FOREIGN KEY ("playlistId") REFERENCES "playlist" ("Id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_767e6bd93eac4ea8d4b54086a0d" FOREIGN KEY ("trackName", "trackArtistName") REFERENCES "track" ("Name", "artistName") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_6ebeb23939d935386eea3caa8fa" FOREIGN KEY ("albumName", "albumArtistName") REFERENCES "album" ("Name", "artistName") ON DELETE NO ACTION ON UPDATE NO ACTION, PRIMARY KEY ("Order", "playlistId", "trackName", "albumName", "trackArtistName"))`);
        await queryRunner.query(`INSERT INTO "temporary_playlist_to_track"("Order", "playlistId", "trackName", "albumName", "trackArtistName", "AddedAt", "albumArtistName") SELECT "Order", "playlistId", "trackName", "albumName", "trackArtistName", "AddedAt", "albumArtistName" FROM "playlist_to_track"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "playlist_to_track" ("Order" integer NOT NULL, "playlistId" integer NOT NULL, "trackName" varchar NOT NULL, "albumName" varchar NOT NULL, "trackArtistName" varchar NOT NULL, "AddedAt" datetime NOT NULL DEFAULT (datetime('now')), "albumArtistName" varchar, PRIMARY KEY ("Order", "playlistId", "trackName", "albumName", "trackArtistName"))`);
        await queryRunner.query(`INSERT INTO "playlist_to_track"("Order", "playlistId", "trackName", "albumName", "trackArtistName", "AddedAt", "albumArtistName") SELECT "Order", "playlistId", "trackName", "albumName", "trackArtistName", "AddedAt", "albumArtistName" FROM "temporary_playlist_to_track"`);
